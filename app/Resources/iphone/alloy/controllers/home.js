...
function Controller() {
    ...
    $.__views.labelTitleBar = Ti.UI.createLabel({
        color: "white",
        tintColor: "white",
        font: {
    ...
    $.__views.titleBar.add($.__views.labelTitleBar);
    $.__views.leftMenu = Ti.UI.createImageView({
        left: 20,
        bottom: 10,
        zIndex: 20,
        image: "/images/icon-menu.png",
        id: "leftMenu"
    });
    ...
    $.__views.__alloyId54.add($.__views.categories);
    ...
    $.__views.popularTab.add($.__views.__alloyId57);
    ...
    $.__views.recentTab.add($.__views.__alloyId59);
