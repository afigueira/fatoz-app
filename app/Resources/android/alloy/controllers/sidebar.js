...
function Controller() {
    ...
    $.__views.profile.add($.__views.__alloyId88);
    ...
    $.__views.achievements.add($.__views.__alloyId94);
    ...
    $.__views.settings.add($.__views.__alloyId97);
    ...
    $.__views.exit.add($.__views.__alloyId100);
