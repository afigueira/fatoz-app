...
function Controller() {
    ...
    $.__views.home.add($.__views.__alloyId267);
    ...
    $.__views.home.add($.__views.__alloyId268);
    ...
    $.__views.profile.add($.__views.__alloyId269);
    ...
    $.__views.profile.add($.__views.__alloyId270);
    ...
    $.__views.categories.add($.__views.__alloyId271);
    ...
    $.__views.categories.add($.__views.__alloyId272);
    ...
    $.__views.challenges.add($.__views.__alloyId273);
    ...
    $.__views.challenges.add($.__views.__alloyId274);
    ...
    $.__views.statistics.add($.__views.__alloyId275);
    ...
    $.__views.statistics.add($.__views.__alloyId276);
    ...
    $.__views.achievements.add($.__views.__alloyId277);
    ...
    $.__views.achievements.add($.__views.__alloyId278);
    ...
    $.__views.settings.add($.__views.__alloyId279);
    ...
    $.__views.settings.add($.__views.__alloyId280);
    ...
    $.__views.exit.add($.__views.__alloyId281);
    ...
    $.__views.exit.add($.__views.__alloyId282);
