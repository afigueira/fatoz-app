...
function Controller() {
    ...
    $.__views.profile.add($.__views.__alloyId89);
    ...
    $.__views.achievements.add($.__views.__alloyId95);
    ...
    $.__views.settings.add($.__views.__alloyId98);
    ...
    $.__views.exit.add($.__views.__alloyId101);
