...
function Controller() {
    ...
    $.__views.__alloyId208.add($.__views.trophy);
    ...
    $.__views.__alloyId209.add($.__views.coverA);
    $.__views.__alloyId210 = Ti.UI.createView({
        width: 250,
        height: Titanium.UI.SIZE,
        id: "__alloyId210"
    });
    $.__views.coverA.add($.__views.__alloyId210);
    ...
    $.__views.__alloyId210.add($.__views.imageProfileA);
    ...
    $.__views.__alloyId210.add($.__views.profileTitleA);
    ...
    $.__views.__alloyId209.add($.__views.searchPlayer);
    $.__views.__alloyId211 = Ti.UI.createImageView({
        top: 20,
        image: "/images/img-queue.png",
        id: "__alloyId211"
    });
    $.__views.searchPlayer.add($.__views.__alloyId211);
    ...
    $.__views.searchPlayer.add($.__views.__alloyId212);
    ...
    $.__views.__alloyId209.add($.__views.profileB);
    ...
    $.__views.profileB.add($.__views.__alloyId213);
    $.__views.__alloyId214 = Ti.UI.createView({
        width: 250,
        height: Titanium.UI.SIZE,
        id: "__alloyId214"
    });
    $.__views.profileB.add($.__views.__alloyId214);
    ...
    $.__views.__alloyId214.add($.__views.imageProfileB);
    ...
    $.__views.__alloyId214.add($.__views.profileTitleB);
    $.__views.drawer = Alloy.createWidget("nl.fokkezb.drawer", "widget", {
        openDrawerGestureMode: "OPEN_MODE_NONE",
        closeDrawerGestureMode: "CLOSE_MODE_MARGIN",
        leftDrawerWidth: 250,
        id: "drawer",
        children: [ $.__views.sidebar, $.__views.__alloyId208 ],
