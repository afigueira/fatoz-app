...
function Controller() {
    ...
    $.__views.__alloyId147.add($.__views.trophy);
    ...
    $.__views.__alloyId148.add($.__views.coverA);
    $.__views.__alloyId149 = Ti.UI.createView({
        width: 250,
        height: Titanium.UI.SIZE,
        id: "__alloyId149"
    });
    $.__views.coverA.add($.__views.__alloyId149);
    ...
    $.__views.__alloyId149.add($.__views.imageProfileA);
    ...
    $.__views.__alloyId149.add($.__views.profileTitleA);
    ...
    $.__views.__alloyId148.add($.__views.searchPlayer);
    $.__views.__alloyId150 = Ti.UI.createImageView({
        top: 20,
        image: "/images/img-queue.png",
        id: "__alloyId150"
    });
    $.__views.searchPlayer.add($.__views.__alloyId150);
    ...
    $.__views.searchPlayer.add($.__views.__alloyId151);
    ...
    $.__views.__alloyId148.add($.__views.profileB);
    ...
    $.__views.profileB.add($.__views.__alloyId152);
    $.__views.__alloyId153 = Ti.UI.createView({
        width: 250,
        height: Titanium.UI.SIZE,
        id: "__alloyId153"
    });
    $.__views.profileB.add($.__views.__alloyId153);
    ...
    $.__views.__alloyId153.add($.__views.imageProfileB);
    ...
    $.__views.__alloyId153.add($.__views.profileTitleB);
    $.__views.drawer = Alloy.createWidget("nl.fokkezb.drawer", "widget", {
        openDrawerGestureMode: "OPEN_MODE_NONE",
        closeDrawerGestureMode: "CLOSE_MODE_MARGIN",
        leftDrawerWidth: 250,
        id: "drawer",
        children: [ $.__views.sidebar, $.__views.__alloyId147 ],
