...
function Controller() {
    ...
    $.__views.__alloyId264.add($.__views.profileTitleA);
    ...
    $.__views.__alloyId262.add($.__views.searchPlayer);
    $.__views.__alloyId266 = Ti.UI.createLabel({
        top: 50,
        text: "Procurando jogador...",
        id: "__alloyId266"
    });
    $.__views.searchPlayer.add($.__views.__alloyId266);
    ...
    $.__views.__alloyId262.add($.__views.profileB);
    $.__views.__alloyId267 = Ti.UI.createView({
        width: 250,
        height: Titanium.UI.SIZE,
        id: "__alloyId267"
    });
    $.__views.profileB.add($.__views.__alloyId267);
    ...
    $.__views.__alloyId267.add($.__views.profileTitleB);
    $.__views.drawer = Alloy.createWidget("nl.fokkezb.drawer", "widget", {
        openDrawerGestureMode: "OPEN_MODE_NONE",
        closeDrawerGestureMode: "CLOSE_MODE_MARGIN",
        leftDrawerWidth: 250,
        id: "drawer",
        children: [ $.__views.sidebar, $.__views.__alloyId261 ],
