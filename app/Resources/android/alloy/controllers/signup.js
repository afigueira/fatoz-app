...
function Controller() {
    ...
    var exports = {};
    var __alloyId167 = [];
    $.__views.__alloyId169 = Ti.UI.createWindow({
    ...
    $.__views.__alloyId169.leftNavButton = $.__views.back;
    ...
    $.__views.__alloyId171.add($.__views.logo);
    ...
    $.__views.__alloyId172.add($.__views.firstName);
    ...
    $.__views.__alloyId174.add($.__views.email);
    ...
    $.__views.__alloyId171.add($.__views.submit);
    ...
    $.__views.__alloyId171.add($.__views.footer);
    ...
    $.__views.__alloyId168 = Ti.UI.createTab({
        window: $.__views.__alloyId169,
        titleid: "signup",
        id: "__alloyId168"
    });
