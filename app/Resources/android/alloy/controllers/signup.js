...
function Controller() {
    ...
    var exports = {};
    var __alloyId288 = [];
    $.__views.__alloyId290 = Ti.UI.createWindow({
    ...
    $.__views.__alloyId290.leftNavButton = $.__views.back;
    ...
    $.__views.__alloyId290.titleControl = $.__views.__alloyId293;
    $.__views.__alloyId294 = Ti.UI.createScrollView({
        layout: "vertical",
        id: "__alloyId294"
    });
    ...
    $.__views.__alloyId294.add($.__views.logo);
    ...
    $.__views.__alloyId294.add($.__views.firstName);
    ...
    $.__views.__alloyId294.add($.__views.lastName);
    ...
    $.__views.__alloyId294.add($.__views.email);
    ...
    $.__views.__alloyId294.add($.__views.password);
    $.__views.states = Ti.UI.createPicker({
        id: "states",
        width: Titanium.UI.FILL
    });
    $.__views.__alloyId294.add($.__views.states);
    $.__views.cities = Ti.UI.createPicker({
        id: "cities",
        width: Titanium.UI.FILL
    });
    $.__views.__alloyId294.add($.__views.cities);
    ...
    $.__views.__alloyId294.add($.__views.terms);
    ...
    $.__views.__alloyId294.add($.__views.submit);
    ...
    $.__views.__alloyId294.add($.__views.footer);
    ...
    $.__views.__alloyId289 = Ti.UI.createTab({
        window: $.__views.__alloyId290,
        titleid: "signup",
        id: "__alloyId289"
    });
