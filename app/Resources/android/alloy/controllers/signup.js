...
function Controller() {
    ...
    var exports = {};
    var __alloyId238 = [];
    $.__views.__alloyId240 = Ti.UI.createWindow({
    ...
    $.__views.__alloyId240.leftNavButton = $.__views.back;
    ...
    $.__views.__alloyId242.add($.__views.logo);
    ...
    $.__views.__alloyId242.add($.__views.firstName);
    ...
    $.__views.__alloyId242.add($.__views.email);
    ...
    $.__views.__alloyId242.add($.__views.password);
    ...
    $.__views.__alloyId242.add($.__views.submit);
    ...
    $.__views.__alloyId242.add($.__views.footer);
    ...
    $.__views.__alloyId239 = Ti.UI.createTab({
        window: $.__views.__alloyId240,
        titleid: "signup",
        id: "__alloyId239"
    });
