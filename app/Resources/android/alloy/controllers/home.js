...
function Controller() {
    ...
    $.__views.__alloyId109.add($.__views.goToCategories);
    ...
    $.__views.goToCategories.add($.__views.__alloyId110);
    ...
    $.__views.__alloyId110.add($.__views.containerLabelHighlight);
    $.__views.__alloyId111 = Ti.UI.createImageView({
        image: "/images/icon-highlights.png",
        id: "__alloyId111"
    });
    $.__views.containerLabelHighlight.add($.__views.__alloyId111);
    ...
    $.__views.__alloyId110.add($.__views.labelSeeCategories);
    ...
    $.__views.__alloyId109.add($.__views.categories);
    ...
    $.__views.popularTab.add($.__views.__alloyId112);
    ...
    $.__views.popularTab.add($.__views.__alloyId113);
    ...
    $.__views.recentTab.add($.__views.__alloyId114);
    ...
    $.__views.recentTab.add($.__views.__alloyId115);
    ...
    $.__views.tabs.add($.__views.__alloyId116);
    ...
    $.__views.__alloyId121.add($.__views.titleCategory);
    ...
    $.__views.__alloyId121.add($.__views.descriptionCategory);
    ...
    $.__views.drawer = Alloy.createWidget("nl.fokkezb.drawer", "widget", {
        ...
        leftDrawerWidth: 250,
        id: "drawer",
        children: [ $.__views.sidebar, $.__views.__alloyId107 ],
