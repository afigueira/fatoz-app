...
function Controller() {
    ...
    $.__views.__alloyId117.add($.__views.goToCategories);
    ...
    $.__views.goToCategories.add($.__views.__alloyId118);
    ...
    $.__views.__alloyId118.add($.__views.containerLabelHighlight);
    $.__views.__alloyId119 = Ti.UI.createImageView({
        image: "/images/icon-highlights.png",
        id: "__alloyId119"
    });
    $.__views.containerLabelHighlight.add($.__views.__alloyId119);
    ...
    $.__views.__alloyId118.add($.__views.labelSeeCategories);
    ...
    $.__views.__alloyId117.add($.__views.categories);
    ...
    $.__views.popularTab.add($.__views.__alloyId120);
    ...
    $.__views.popularTab.add($.__views.__alloyId121);
    ...
    $.__views.recentTab.add($.__views.__alloyId122);
    ...
    $.__views.recentTab.add($.__views.__alloyId123);
    ...
    $.__views.tabs.add($.__views.__alloyId124);
    ...
    $.__views.__alloyId128.add($.__views.titleCategory);
    ...
    $.__views.__alloyId128.add($.__views.descriptionCategory);
    ...
    $.__views.__alloyId134.add($.__views.titleCategory);
    $.__views.descriptionCategory = Ti.UI.createLabel({
        color: "white",
        tintColor: "white",
        font: {
    ...
    $.__views.__alloyId134.add($.__views.descriptionCategory);
    ...
    $.__views.__alloyId117.add($.__views.__alloyId139);
