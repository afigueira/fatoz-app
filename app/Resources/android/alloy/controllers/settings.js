...
function Controller() {
    ...
    $.__views.__alloyId206.add($.__views.editImageProfile);
    ...
    $.__views.editImageProfile.add($.__views.__alloyId207);
    ...
    $.__views.editImageProfile.add($.__views.__alloyId208);
    ...
    $.__views.__alloyId205.add($.__views.firstName);
    ...
    $.__views.__alloyId205.add($.__views.lastName);
    ...
    $.__views.__alloyId205.add($.__views.email);
    ...
    $.__views.__alloyId205.add($.__views.password);
    ...
    $.__views.__alloyId205.add($.__views.submit);
