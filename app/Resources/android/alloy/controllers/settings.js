...
function Controller() {
    ...
    $.__views.__alloyId216.add($.__views.editImageProfile);
    ...
    $.__views.editImageProfile.add($.__views.__alloyId217);
    ...
    $.__views.editImageProfile.add($.__views.__alloyId218);
    ...
    $.__views.__alloyId215.add($.__views.firstName);
    ...
    $.__views.__alloyId215.add($.__views.lastName);
    ...
    $.__views.__alloyId215.add($.__views.email);
    ...
    $.__views.__alloyId215.add($.__views.password);
    ...
    $.__views.__alloyId215.add($.__views.submit);
    $.__views.drawer = Alloy.createWidget("nl.fokkezb.drawer", "widget", {
        openDrawerGestureMode: "OPEN_MODE_NONE",
        closeDrawerGestureMode: "CLOSE_MODE_MARGIN",
        leftDrawerWidth: 250,
        id: "drawer",
        children: [ $.__views.sidebar, $.__views.__alloyId213 ],
